...
class Predict2Folder():
    def __init__(self, model, list_file_flair, checkpoint_list, \
                device, num_class=2, team_name="nhatvbd", \
...
if __name__ == "__main__":
    ...
    # Load checkpoint
    # predict
    folder = Predict2Folder(model, list_file_flair, checkpoint_list, \
                device, team_name="nhatvinbig",\
