...
class ISBILoader(Dataset):
    def __init__(self, train_path="", transform=None, list_subject=[], 
                 extraction_step=24, patch_size=96, extract=False):
        if list_subject:
    ...
    ####################### augmentation data ##############################
        ...
        if self.extract:
            start_indexes = (self.extraction_step * torch.randint(3, (1,)), self.extraction_step * torch.randint(5, (1,)), \
