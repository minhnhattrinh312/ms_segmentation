    ...
    for count_subject, path_flair in tqdm(enumerate(list_file_flair, 1)):
        ...
        for view, transpose_view in zip(views, cfg.DATA.ORIGIN2CUT):
            ...
            for i in range(transposed_flair.shape[-1]):
                ...
                slice_inputs = np.stack([slices_t1, slices_flair, slices_t2, slices_dp, slices_gado], axis=-1) #shape (224, 224, 4)
...
if __name__ == "__main__":
    ...
    extract2d_data2npz(list_file_flair, cfg, distinct_subject=cfg.TRAIN.DISTINCT_SUBJECT, save_path="./data/msseg2016npz/")