...
os.makedirs(cfg.DIRS.SAVE_RESNET50, exist_ok=True)
...
if cfg.TRAIN.LOAD_CKPT:
    #load checkpoint
    try:
        checkpoint = torch.load(cfg.DIRS.SAVE_RESNET50 + "best_model.pt")
...
optimizer = Nadam(learner.parameters(), lr=2e-4)


# Initialize wandb
wandb.init(project="pcl", name="resnet_3modalities", id="resnet_3modalities", resume="allow")
...
patience_epoch = 35
save_dir = cfg.DIRS.SAVE_RESNET50
data_loader = DataLoader(dataset, batch_size=cfg.TRAIN.BATCH_SIZE, pin_memory=True,
    ...
    for epoch in range(num_epochs):
        ...
        for images in tqdm(data_loader):
            ...
            if global_step % 1000 == 0:
                ...
                wandb.log({"Loss": running_loss_1000/1000, "Learning Rate": optimizer.param_groups[0]['lr']})
                running_loss_1000 = 0
        ...
        wandb.log({"Mean Loss": mean_loss, "Learning Rate": optimizer.param_groups[0]['lr'], "Epoch": epoch})
